...
class POSController extends Controller
{
    ...
    public function draft()
    {
        ...
        $postCarts = PosCartRepository::query()->where('shop_id', $shop->id)->where('is_draft', true)->orderBy('created_at', 'desc')->get();
    ...
    public function getProduct(Request $request)
    {
        ...
        $products = $shop->products()->when($category, function ($product) use ($category) {
