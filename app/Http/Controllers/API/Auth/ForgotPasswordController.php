...
class ForgotPasswordController extends Controller
{
    ...
    {
        \Log::info('ForgotPasswordController resendOTP method called');
        ...
        if ($user && $user->is_active) {
            ...
            \Log::info('verifyManage: ' . json_encode($verifyManage));
            ...
            $emailOrPhone = null;
            $messageType = $request->forgot_password ? 'Parola uitată' : 'Verificare';
            ...
            $message = 'Codul tău OTP pentru '.$messageType.' la SecondHub este '.$verificationCode->otp;

            $OTP = $verificationCode->otp;

            $phoneCode = null;
            if ($type == 'phone') {
                \Log::info('type is phone');
                try {
                ...
                $responseMessage = 'Codul tău de '.$messageType.' a fost trimis pe telefonul tău';
                ...
                $responseMessage = 'Codul tău de '.$messageType.' a fost trimis pe emailul tău';
