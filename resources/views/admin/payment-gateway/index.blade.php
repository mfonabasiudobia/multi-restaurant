...
@section('content')
    <div class="container-fluid mb-3">
        ...
        <div class="card mt-5">
            ...
            <div class="card-body">
                <form action="{{ route('admin.paymentGateway.updateBankDetails') }}" method="POST">
                    @csrf
                    <div class="mt-3">
                        <x-input name="bank_name" type="text" label="Bank Name" :value="$bankDetails->bank_name ?? ''" required="true"/>
                    </div>

                    <div class="mt-3">
                        <x-input name="company_name" type="text" label="Company Name" :value="$bankDetails->company_name ?? ''" required="true"/>
                    </div>

                  

                    <div class="mt-3">
                        <x-input name="iban" type="text" label="IBAN" :value="$bankDetails->iban ?? ''" required="true"/>
                    </div>

                    <div class="mt-3">
                        <x-input name="swift_bic" type="text" label="SWIFT/BIC" :value="$bankDetails->swift_bic ?? ''" required="true"/>
                    </div>
