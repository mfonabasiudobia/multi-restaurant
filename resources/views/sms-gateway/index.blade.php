                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    @unless(auth()->user()->can('admin.sms-gateway.update'))
                                                        <small class="text-muted">Your Twilio Account SID from twilio.com/console</small>
                                                    @endunless
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    @unless(auth()->user()->can('admin.sms-gateway.update'))
                                                        <small class="text-muted">Your Twilio Auth Token from twilio.com/console</small>
                                                    @endunless
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <x-input value="{{ $twilio?->twilio_from }}" name="twilio_from"
                                                        type="text" placeholder="Twilio From (SMS Number)" />
                                                    @unless(auth()->user()->can('admin.sms-gateway.update'))
                                                        <small class="text-muted">Your Twilio phone number for sending SMS (format: +1234567890)</small>
                                                    @endunless
                                                </div>
                                                <div class="col-md-12">
                                                    <x-input value="{{ $twilio?->twilio_whatsapp_from }}" name="twilio_whatsapp_from"
                                                        type="text" placeholder="Twilio From (WhatsApp Number)" />
                                                    @unless(auth()->user()->can('admin.sms-gateway.update'))
                                                        <small class="text-muted">Your Twilio WhatsApp number (format: +1234567890)</small>
                                                    @endunless
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    @unless(auth()->user()->can('admin.sms-gateway.update'))
                                                        <small class="text-muted">Your Telesign Customer ID from dashboard</small>
                                                    @endunless
                                                </div>
                                                <div class="col-md-12">
                                                    ...
                                                    @unless(auth()->user()->can('admin.sms-gateway.update'))
                                                        <small class="text-muted">Your Telesign API Key from dashboard</small>
                                                    @endunless
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    @unless(auth()->user()->can('admin.sms-gateway.update'))
                                                        <small class="text-muted">Your Nexmo API Key from dashboard</small>
                                                    @endunless
                                                </div>
                                                <div class="col-md-12">
                                                    ...
                                                    @unless(auth()->user()->can('admin.sms-gateway.update'))
                                                        <small class="text-muted">Your Nexmo API Secret from dashboard</small>
                                                    @endunless
                                                </div>
                                                <div class="col-md-12 mt-3">
                                                    ...
                                                    @unless(auth()->user()->can('admin.sms-gateway.update'))
                                                        <small class="text-muted">Your Nexmo sender number or name</small>
                                                    @endunless
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <x-input value="{{ $messageBird?->api_key }}" name="api_key"
                                                        type="text" placeholder="API Key" />
                                                    @unless(auth()->user()->can('admin.sms-gateway.update'))
                                                        <small class="text-muted">Your MessageBird API Key from dashboard</small>
                                                    @endunless
                                                </div>
                                                <div class="col-md-12">
                                                    ...
                                                    @unless(auth()->user()->can('admin.sms-gateway.update'))
                                                        <small class="text-muted">Your MessageBird sender number or name</small>
                                                    @endunless
                                                </div>
                                            </div>
                                        </div>
