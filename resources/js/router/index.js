...
const DeletionPolicy = () => import("../pages/DeletionPolicy.vue");
...
const SubpageView = () => import("../pages/SubPageView.vue");
const Notification = () => import("../components/Notification.vue");
import FilteredProducts from "../pages/FilteredProducts.vue";

// 404 page
const NotFound = () => import("../errors/404.vue");

// Add routes for payment success and failure
