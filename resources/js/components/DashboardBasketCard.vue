                            ...
                            <TransitionChild as="template"
                                ...
                                <DialogPanel class="pointer-events-auto relative w-screen max-w-md">
                                    ...
                                    <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                        ...
                                        <!-- Proceed to Checkout -->
                                        <div v-if="BasketStore.selectedProducts.length > 0" class="flex gap-6 p-6 border-t border-slate-200">
                                            <div>
                                                <div class="text-center text-slate-500 text-base font-normal leading-tight">
                                                    {{ $t('Cart Amount') }}
                                                </div>
                                                <div class="text-slate-900 text-lg sm:text-2xl font-bold leading-normal">{{ master.showCurrency(BasketStore.selectedProductsTotal) }}</div>
                                            </div>
