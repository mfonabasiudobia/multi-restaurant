<template>
    <div class="rounded-lg border transition-all duration-300 group bg-white overflow-hidden relative"
        ...
        <div class="grid grid-cols-3">
            <div class="w-full h-[124px] overflow-hidden shrink-0 cursor-pointer" @click.stop="showProductDetails"
            ...
            <div class="bg-white p-2 flex flex-col items-start gap-2 col-span-2">
                <div class="flex flex-col items-start gap-2 w-full cursor-pointer" @click.stop="showProductDetails">
